# A library file for simplifying pygame interaction. <br/><b>Required:</b> you must download <code>gamebox.py</code> to use the other files here.
...
if __name__ == "__main__":
    ...
    smurfs = load_sprite_sheet("http://roussinavalkova.com/blog/wp-content/uploads/2011/04/smurf_sprite.png", 4, 4)
    
    music = load_sound("http://www.gnu.org/fun/jokes/eternal-flame.ogg")
    sound = music.play()
